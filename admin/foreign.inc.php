...
echo "<noscript><p><input type='submit' class='button' name='change' value='", lang('Change'), "'></p></noscript>";
echo "</p>\n";
...
echo "<noscript><p><input type='submit' class='button' name='add' value='", lang('Add column'), "'></noscript>";
