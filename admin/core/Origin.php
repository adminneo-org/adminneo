...
abstract class Origin extends Plugin
{
	 ...
	 *
	 * Group ID: 1 - overall UI settings,
	...
	public function getSettingsRows(): array
	{
		...
		if ($options) {
			$settings[1]["lang"] = "<tr><th>" . lang('Language') . "</th>" .
				"<td>" .
		...
		$settings[1]["colorMode"] = "<tr><th>" . lang('Color mode') . "</th>" .
			"<td>" .
		...
		// Records per page.
		$settings[2]["recordsPerPage"] = "<tr><th>" . lang('Records per page') . "</th>" .
			"<td>" .
		...
		$settings[2]["enumAsSelectThreshold"] = "<tr><th>" . lang('Enum as select') . "</th>" .
			"<td>" .
