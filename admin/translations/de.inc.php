...
return [
	...
	'None of the supported PHP extensions (%s) are available.' => 'Keine der unterstützten PHP-Erweiterungen (%s) ist vorhanden.', // %s contains the list of the extensions, e.g. 'mysqli, PDO_MySQL'
	...
	'The maximum number of files is %d. Select fewer files or increase the %s configuration directive.' => 'Die maximale Anzahl an Dateien beträgt %d. Wählen Sie weniger Dateien aus oder erhöhen Sie den Wert der Konfigurationsanweisung %s.',
	'The maximum total size of files is %s. Select smaller files or increase the %s configuration directive.' => 'Die maximale Gesamtgröße der Dateien beträgt %s. Wählen Sie kleinere Dateien aus oder erhöhen Sie den Wert der Konfigurationsanweisung %s.',
	'Too big POST data. Reduce the data or increase the %s configuration directive.' => 'POST-Daten sind zu groß. Reduzieren Sie die Größe oder erhöhen Sie den Wert der Konfigurationsanweisung %s.',
	...
	'Edit' => 'Bearbeiten',
	'original' => 'Original',
	'empty' => 'leer', // label for value '' in enum data type
	'Insert' => 'Einfügen',
	'Save' => 'Speichern',
	...
	'Clone' => 'Klonen',
	'Delete' => 'Entfernen',
	'Item%s has been inserted.' => 'Datensatz%s wurde eingefügt.', // %s can contain auto-increment value, e.g. ' 123'
	...
	'Ask %s' => '%s fragen', // Use the phrase from https://gemini.google.com/
