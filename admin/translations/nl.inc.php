...
return [
	...
	'The maximum number of files is %d. Select fewer files or increase the %s configuration directive.' => 'Het maximale aantal bestanden is %d. Selecteer minder bestanden of verhoog de configuratiewaarde %s.',
	'The maximum total size of files is %s. Select smaller files or increase the %s configuration directive.' => 'De maximale totale grootte van bestanden is %s. Kies kleinere bestanden of verhoog de configuratiewaarde %s.',
	'Too big POST data. Reduce the data or increase the %s configuration directive.' => 'POST-data is te groot. Verklein de hoeveelheid data of verhoog de configuratiewaarde %s.',
	...
	'Ask %s' => 'Vraag het aan %s', // Use the phrase from https://gemini.google.com/
