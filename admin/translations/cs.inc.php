...
return [
	...
	'None of the supported PHP extensions (%s) are available.' => 'Není dostupné žádné z podporovaných PHP rozšíření (%s).', // %s contains the list of the extensions, e.g. 'mysqli, PDO_MySQL'
	...
	'The maximum total size of files is %s. Select smaller files or increase the %s configuration directive.' => 'Maximální celková velikost souborů je %s. Vyberte menší soubory nebo zvyšte hodnotu konfigurační direktivy %s.',
	...
	'Clone' => 'Klonovat',
	'Delete' => 'Smazat',
	'Item%s has been inserted.' => 'Položka%s byla vložena.', // %s can contain auto-increment value, e.g. ' 123'
	...
	'Simple' => 'Jednoduchý',
	'Dual' => 'Dvojitý',
	'Dual on hover' => 'Dvojitý při najetí myší',
	'Reversed' => 'Obrácený',
