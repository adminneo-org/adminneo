...
return [
	...
	// Connection
	'No driver' => 'Без управљачког програма', // by Claude Opus 5
	'Database driver not found.' => 'Управљачки програм базе података није пронађен.', // by Claude Opus 5
	...
	'Just a sec...' => 'Само тренутак...', // by Claude Opus 5
];
